...
import { useEffect, useState, useRef, useMemo as useMemo2 } from "react";
...
var PluginRunnerContext = createContext(null);
var PluginProvider = ({
  plugins = [],
  context,
  runner: runnerProp,
  ...
  return /* @__PURE__ */ jsx(PluginRunnerContext.Provider, { value: computed, children });
};
...
var MessageComponentRegistry = class {
  ...
  renderFallback(message) {
    if (message.fileUrl) {
      return /* @__PURE__ */ jsx2("a", { href: message.fileUrl, target: "_blank", rel: "noreferrer", children: message.text || message.fileName });
    }
    return /* @__PURE__ */ jsx2("span", { children: message.text });
  }
};
var QuickReplies = (message, helpers) => {
  var _a;
  return /* @__PURE__ */ jsxs("div", { className: "cs-quick-replies", role: "group", "aria-label": "Suggested replies", children: [
    message.text && /* @__PURE__ */ jsx2("div", { className: "cs-chat-message-text", children: message.text }),
    /* @__PURE__ */ jsx2("div", { className: "cs-quick-replies-list", children: (((_a = message.payload) == null ? void 0 : _a.actions) || []).map((action) => /* @__PURE__ */ jsx2(
      "button",
      {
...
var CardRenderer = (message) => {
  ...
  return /* @__PURE__ */ jsxs("article", { className: "cs-card", "aria-label": payload.title || message.text, children: [
    payload.imageUrl && /* @__PURE__ */ jsx2("div", { className: "cs-card-media", children: /* @__PURE__ */ jsx2("img", { src: payload.imageUrl, alt: payload.title || "Card image" }) }),
    /* @__PURE__ */ jsxs("div", { className: "cs-card-content", children: [
      /* @__PURE__ */ jsx2("h4", { children: payload.title || message.text }),
      payload.body && /* @__PURE__ */ jsx2("p", { children: payload.body }),
      payload.actions && /* @__PURE__ */ jsx2("div", { className: "cs-card-actions", children: payload.actions.map((action) => /* @__PURE__ */ jsx2("a", { href: action.url || "#", className: "cs-card-link", children: action.label }, action.value)) })
    ] })
  ] });
};
var ProductRenderer = (message) => {
  const payload = message.payload || {};
  return /* @__PURE__ */ jsxs("article", { className: "cs-card", "aria-label": payload.title || "Product", children: [
    payload.imageUrl && /* @__PURE__ */ jsx2("div", { className: "cs-card-media", children: /* @__PURE__ */ jsx2("img", { src: payload.imageUrl, alt: payload.title || "Product image" }) }),
    /* @__PURE__ */ jsxs("div", { className: "cs-card-content", children: [
      /* @__PURE__ */ jsx2("h4", { children: payload.title || message.text }),
      payload.body && /* @__PURE__ */ jsx2("p", { children: payload.body }),
      payload.actions && payload.actions.length > 0 && /* @__PURE__ */ jsx2("div", { className: "cs-card-actions", children: payload.actions.map((action) => /* @__PURE__ */ jsx2("a", { href: action.url || "#", className: "cs-card-link", children: action.label }, action.value)) })
    ] })
  ] });
};
var SurveyRenderer = (message, helpers) => {
  const payload = message.payload || {};
  return /* @__PURE__ */ jsxs("div", { className: "cs-survey", role: "form", "aria-label": payload.title || "Survey", children: [
    /* @__PURE__ */ jsxs("div", { className: "cs-survey-header", children: [
      /* @__PURE__ */ jsx2("strong", { children: payload.title || message.text }),
      payload.body && /* @__PURE__ */ jsx2("p", { children: payload.body })
    ] }),
    /* @__PURE__ */ jsx2("div", { className: "cs-survey-actions", role: "group", "aria-label": "Survey responses", children: (payload.actions || []).map((action) => /* @__PURE__ */ jsx2(
      "button",
      {
        type: "button",
        className: "cs-quick-reply",
...
defaultMessageRegistry.register("text", (msg) => /* @__PURE__ */ jsx2("span", { children: msg.text }));
...
var CustomerSupportChatWidget = ({
  ...
  const [transportInstance, setTransportInstance] = useState(null);
  const [connectionState, setConnectionState] = useState("idle");
  const transportOverrides = useMemo2(
    () => transportOptions || {},
    [transportOptions]
  );
  ...
  return /* @__PURE__ */ jsx3(PluginProvider, { plugins, context: pluginContext, runner: pluginRunner, children: /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx3(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx3("span", { className: "cs-chat-launcher-icon", "aria-hidden": "true", children: "\u{1F4AC}" })
          }
        ),
        isOpen && /* @__PURE__ */ jsxs2("div", { className: "cs-chat-panel", children: [
          /* @__PURE__ */ jsxs2("div", { className: "cs-chat-header", children: [
            /* @__PURE__ */ jsxs2("div", { className: "cs-chat-header-main", children: [
              /* @__PURE__ */ jsx3("div", { className: "cs-chat-title", children: title }),
              /* @__PURE__ */ jsx3("div", { className: "cs-chat-subtitle", children: renderSubtitle() })
            ] }),
            /* @__PURE__ */ jsx3(
              "button",
              {
          ...
          /* @__PURE__ */ jsxs2("div", { className: "cs-chat-body", children: [
            error && /* @__PURE__ */ jsx3("div", { className: "cs-chat-error", children: error }),
            /* @__PURE__ */ jsxs2("div", { className: "cs-chat-messages", children: [
              messages.map((msg) => /* @__PURE__ */ jsx3(
                "div",
                {
                  className: `cs-chat-message cs-chat-message--${msg.sender}`,
                  children: /* @__PURE__ */ jsx3("div", { className: "cs-chat-message-bubble", children: registry.render(msg, { onQuickReply: handleQuickReply }) })
                },
                msg.id
              )),
              isLoading && /* @__PURE__ */ jsx3("div", { className: "cs-chat-message cs-chat-message--bot", children: /* @__PURE__ */ jsxs2("div", { className: "cs-chat-message-bubble cs-chat-typing-indicator", children: [
                /* @__PURE__ */ jsx3("span", { className: "cs-dot" }),
                /* @__PURE__ */ jsx3("span", { className: "cs-dot" }),
                /* @__PURE__ */ jsx3("span", { className: "cs-dot" })
              ] }) }),
          ...
          /* @__PURE__ */ jsxs2("form", { className: "cs-chat-input-row", onSubmit: handleSubmit, children: [
            /* @__PURE__ */ jsx3(
              "input",
              {
                ref: fileInputRef,
...
import { useCallback as useCallback2, useMemo as useMemo4, useRef as useRef3 } from "react";
...
function useConversationFeed(service, initialCursor = "start") {
  ...
  const cursorRef = useRef2(initialCursor);
  const abortRef = useRef2(null);
  const conversations = useMemo3(
...
var ConversationSidebar = ({
  ...
  const sorted = useMemo4(() => sortConversations(conversations), [conversations]);
  ...
  const renderItem = (conversation, index) => {
    ...
    return /* @__PURE__ */ jsx4("li", { className: "cs-sidebar-row", children: /* @__PURE__ */ jsxs3(
      "button",
      {
        type: "button",
        role: "option",
        ...
        children: [
          /* @__PURE__ */ jsxs3("div", { className: "cs-sidebar-item__header", children: [
            /* @__PURE__ */ jsx4("span", { className: "cs-sidebar-item__title", children: conversation.title }),
            /* @__PURE__ */ jsx4("span", { className: "cs-sidebar-item__timestamp", "aria-label": "Last updated", children: formatTimestamp(conversation.lastMessageAt) })
          ] }),
          /* @__PURE__ */ jsxs3("div", { className: "cs-sidebar-item__body", children: [
            /* @__PURE__ */ jsx4("span", { className: "cs-sidebar-item__preview", children: renderPreview(conversation.lastMessagePreview) }),
            conversation.unread ? /* @__PURE__ */ jsx4("span", { className: "cs-sidebar-item__unread", "aria-label": "Unread" }) : null
          ] }),
          conversation.participantLabel ? /* @__PURE__ */ jsx4("span", { className: "cs-sidebar-item__participant", children: conversation.participantLabel }) : null
        ]
      }
    ) }, conversation.id);
  };
  return /* @__PURE__ */ jsxs3("aside", { className: "cs-sidebar", "aria-label": "Conversation list", children: [
    /* @__PURE__ */ jsxs3("div", { className: "cs-sidebar__header", children: [
      /* @__PURE__ */ jsx4("h2", { className: "cs-sidebar__title", children: title }),
      loading ? /* @__PURE__ */ jsx4("span", { className: "cs-sidebar__spinner", "aria-live": "polite", children: "Loading\u2026" }) : null
    ] }),
    error ? /* @__PURE__ */ jsxs3("div", { className: "cs-sidebar__error", role: "alert", children: [
      /* @__PURE__ */ jsx4("p", { children: "We could not load conversations. Please retry." }),
      /* @__PURE__ */ jsx4("button", { type: "button", onClick: retry, className: "cs-sidebar__retry", children: "Retry" })
    ] }) : null,
    /* @__PURE__ */ jsxs3(
      "ul",
      {
        ...
        children: [
          ...
          !loading && sorted.length === 0 && !error ? /* @__PURE__ */ jsx4("li", { className: "cs-sidebar__empty", children: "No conversations yet." }) : null,
          loading ? /* @__PURE__ */ jsx4("li", { className: "cs-sidebar__loading", children: "Loading conversations\u2026" }) : null
        ]
      }
    ),
    hasMore && !loading ? /* @__PURE__ */ jsx4("button", { type: "button", className: "cs-sidebar__load-more", onClick: loadMore, children: "Load more" }) : null
  ] });
};
export {
  AbortSendError,
